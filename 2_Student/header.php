            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (document.getElementById('new-notification-flag')) {
                        document.getElementById('notificationIcon').src = '../3_image/newnotification.png';
                    } else {
                        document.getElementById('notificationIcon').src = '../3_image/notification.png';
                    }
                },
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                <div class="d-flex align-items-center">
                    <span class="notification-icon" onclick="toggleNotifications()">
                        <img id="notificationIcon" src="../3_image/notification.png" alt="Notifications" width="20">
                    </span>
